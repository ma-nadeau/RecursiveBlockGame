...
public class BlockTest {
    ...
    static String BLOCK_CHILDREN_FIELD_NAME = "children"; // this should be set to the name of your block's "children"
                                                          // field
...

    {
        try {
            ...
            // I know, printing when I said not to. This is not a test, you just need this
    ...
    public void Block_randomConstructor_randomSmashingWorksAsExpected() throws IllegalAccessException {
        // This is more of an integration test and kind of goes against the tester's
        // guidelines. I apologize,
        // but I still think it's better to have it and I didn't find a better way to
        // test this.
        // If you find a better way to verify that the random Block constructor
        // generates sub-block in the right way,
        ...
        // levels are the only verifiable/replicatable elements of the teacher's example
        // on page 9
    ...
    void Block_updateSizeAndPosition_throwsIllegalArgumentExceptionWhenSizeNonDivisibleByPow2MaxDepth(Integer lvl,
            Integer maxDepth, Integer size) {
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    void Block_updateSizeAndPosition_worksWhenSizeDivisibleByPow2MaxDepth(Integer lvl, Integer maxDepth, Integer size)
