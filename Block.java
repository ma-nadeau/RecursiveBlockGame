...
public class Block {
	...
	public ArrayList<BlockToDraw> getBlocksToDraw() {
		...
		//BlockToDraw OuterBox2 = new BlockToDraw(GameColors.FRAME_COLOR,this.xCoord,this.yCoord,this.size, 3);
	...
	public Color[][] flatten() {
		...
		if(children.length == 0) {
			...
			/*
				...
				children[3].updateSizeAndPosition(halfSize, xCoord + halfSize, yCoord + halfSize); LR
			*/
